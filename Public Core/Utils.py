...
json = js.load(open("./Settings.json",  "r"))  

def display(type, text):
    consts = {
        "ERROR": "[{:%d/%m/%y | %H:%M}] [Error]",
        "MODULE ERROR": "[{:%d/%m/%y | %H:%M}] [Module Error]",
        "UNKNOWN ERROR": "[{:%d/%m/%y | %H:%M}] [Unknown Error]",
        "INFO": "[{:%d/%m/%y | %H:%M}] [Info]",
        "WARNING": "[{:%d/%m/%y | %H:%M}] [Warning]",
        "METRIC ALERT": "[{:%d/%m/%y | %H:%M}] [Metric Alert]",
        "LOG FAILURE": "[{:%d/%m/%y | %H:%M}] [Log Failure]",
        "COMMAND INPUT ERROR": "[{:%d/%m/%y | %H:%M}] [Input Error]",
        "API": "[{:%d/%m/%y | %H:%M}] [API Response]"
    }
    colours = {
        "ERROR": "red",
        "MODULE ERROR": "red",
        ...
        "INFO": "cyan",
        "WARNING": "yellow",
        "METRIC ALERT": "magenta",
        "LOG FAILURE": "red",
        "COMMAND INPUT ERROR": "yellow",
        "API": "green"
    }
